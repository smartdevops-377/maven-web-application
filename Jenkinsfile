node {
    ...
    stage("checkout") {
        git branch: '${params.branch}', credentialsId: '5b3c31cc-0bb2-446c-a991-7681eb94b2d8', url: 'https://github.com/smartdevops-377/maven-web-application.git'
    }
...
stage ("deploy to the container")
{
    ...
    echo "deployed succesfully the multi branch pipeline"
}
}
